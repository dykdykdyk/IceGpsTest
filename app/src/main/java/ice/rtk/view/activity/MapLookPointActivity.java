...
import ice.rtk.view.customview.PointShowView;
import ice.rtk.view.customview.ScaleView;
import ice.rtk.view.customview.PointShowView;


public class MapLookPointActivity extends BaseActivity implements PointShowView.OnMapStatusChangeListener {

    @BindView(R.id.mapview)
    PointShowView mapview;
