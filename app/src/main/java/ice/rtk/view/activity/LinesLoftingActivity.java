...
import ice.rtk.utils.viewtools.LinesRender;


public class LinesLoftingActivity extends BaseActivity implements LinesLoftingView.OnMapStatusChangeListener {
    @BindView(R.id.mapview)
    LinesLoftingView mapview;
    ...
    protected void init() {
        ...
        if (intent != null) {
            ...
            if (lat != null) {
                ...
                mapRenderLines = new LinesRender(mapview, this);
            }
        }
        mapRenderLines = new LinesRender(mapview, this);
    }
    ...
    protected void setListener() {
        ...
        mapRenderLines.setMapDataChangeListener(new LinesRender.LinesMapDataChangeListener() {
            @Override
