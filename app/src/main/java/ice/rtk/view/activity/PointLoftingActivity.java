...
import ice.rtk.utils.viewtools.PointRender;
import ice.rtk.view.customview.PointLoftingView;


public class PointLoftingActivity extends BaseActivity implements PointLoftingView.OnMapStatusChangeListener {
    @BindView(R.id.mapview)
    PointLoftingView mapview;
...
//                current= {22.7052679964,114.2435153866,50};
                ...
                mapRender =new PointRender(mapview, this);
            }
        }
        mapRender =new PointRender(mapview,this);
    }
...
//        double[] current= {22.7052679964,114.2435153866,50};
    ...
    protected void setListener() {
        ...
        mapRender.setMapDataChangeListener(new PointRender.MapDataChangeListener() {
            @Override
