...
import ice.rtk.view.PointView.MapView;
...
public class MapRenderLines {
    private final Activity activity;
    private final LinesView mapview;
    ThreadPool threadPool;
    double[] start;
    double[] end;
    double[] current;
    private final int MAX_COUNT=1000;
    public MapRenderLines(LinesView mapview, Activity activity){
